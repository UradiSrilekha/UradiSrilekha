...
**Full-Stack Developer | Data Science & AI Enthusiast | Computer Science Undergraduate**
...
I’m a **Computer Science undergraduate** passionate about **full-stack web development**, **data science**, and **machine learning**. I build real-world projects using **MERN (React + Node.js)**, **Django**, **Python**, **Java**, and **SQL**, and experiment with **AI/ML models** using **PyTorch** and **TensorFlow**.

I actively participate in **hackathons**, **coding challenges** (CodeChef, HackerRank, LeetCode), and **online certifications** to sharpen my problem-solving and development skills. I’m focused on becoming a **Software Developer / Data Scientist** and contributing to impactful, real-world applications.
...
<div align="center">
  ...
  ### Backend & Databases
  <img src="https://skillicons.dev/icons?i=nodejs,express,mongodb,mysql,postgresql,redis" alt="backend"/>
  
  ### Cloud, DevOps & Tooling
  <img src="https://skillicons.dev/icons?i=docker,kubernetes,aws,git,github,jenkins,linux" alt="devops"/>
...
| **Natural Language Processing** | ⭐⭐⭐⭐ | Text Processing, Sentiment Analysis, Language Models, RAG |
| **Generative AI** | ⭐⭐⭐⭐⭐ | LLMs, Prompt Engineering, AI Agents, LangChain, AutoGen |
| **Computer Vision** | ⭐⭐⭐ | Image Classification, Object Detection, OpenCV |
| **MLOps** | ⭐⭐⭐ | Model Deployment, Docker, CI/CD for ML, Monitoring |
| **AI APIs & Integration** | ⭐⭐⭐⭐⭐ | OpenAI, Anthropic, Hugging Face, Custom Model Integration |
...
- Participating in **hackathons** and **virtual internships** (EduSkills Foundation, etc.)
- Completing certifications in **Data Analytics** and **Full-Stack Development**
- Regularly solving problems on **CodeChef**, **HackerRank**, and **LeetCode**
- Building and deploying real-world projects using **Render**, **Vercel**, and **GitHub Pages**

---

## 🤝 What I’m Looking For

- Internships in **Software Development**, **Full-Stack**, or **Data Science**
...
- **LinkedIn**: [Srilekha Uradi](https://www.linkedin.com/in/uradisrilekha)  
- **GitHub**: [UradiSrilekha](https://github.com/UradiSrilekha)

---

<div align="center">
  <em>Building solutions with code, data, and creativity. Let’s connect and create something impactful!</em>
</div>
